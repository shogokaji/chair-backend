class User < ActiveRecord::Base
  ...
  scope :search_department, ->(department) { where(department: department) if department.present? }

  scope :search_age, ->(age) { where(age: age) if age.present? }
  
  scope :search_sex, ->(sex) { where(sex: sex) if sex.present? }
